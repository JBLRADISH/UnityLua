public class ObjectWrap
{
	public static void Register()
	{
		...
		LuaCallback.RegisterVar("name", get_name, set_name);
		LuaCallback.RegisterVar("hideFlags", get_hideFlags, set_hideFlags);
	...
	[AOT.MonoPInvokeCallback(typeof(LuaCallback.LuaCFunction))]
	public static int get_name(System.IntPtr L)
	{
		if (true && LuaAPI.IsObject(L, 1))
		{
			UnityEngine.Object arg0 = (UnityEngine.Object)LuaCallback.ToObject(L, 1);
			System.String res = arg0.name;
			LuaCallback.PushString(L, res); 
			return 1;
		}
		return 0;
	...
	[AOT.MonoPInvokeCallback(typeof(LuaCallback.LuaCFunction))]
	public static int set_name(System.IntPtr L)
	{
