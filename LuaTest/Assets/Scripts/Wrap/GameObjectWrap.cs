public static class GameObjectWrap
{
    ...
    public static int CreatePrimitive(System.IntPtr L)
    {
        ...
        if (nargs == 1 && LuaAPI.IsNumber(L, 1))
        {
            ...
            UnityEngine.PrimitiveType arg0 = (UnityEngine.PrimitiveType)LuaAPI.ToNumber(L, 1);
    ...
    public static int GetComponent(System.IntPtr L)
    {
        ...
        {
            UnityEngine.GameObject arg0 = LuaCallback.ToObject<UnityEngine.GameObject>(L, 1);
            System.Type arg1 = LuaCallback.ToType(L, 2);
        ...
        {
            UnityEngine.GameObject arg0 = LuaCallback.ToObject<UnityEngine.GameObject>(L, 1);
            System.String arg1 = LuaCallback.ToString(L, 2);
            UnityEngine.Component res = arg0.GetComponent(arg1);
            LuaCallback.PushObject(L, res);
            return 1;
        }
    ...
    public static int GetComponents(System.IntPtr L)
    {
        ...
        if (nargs == 3 && LuaAPI.IsObject(L, 1) && LuaAPI.IsNumber(L, 2) && LuaAPI.IsObject(L, 3))
        {
            UnityEngine.GameObject arg0 = LuaCallback.ToObject<UnityEngine.GameObject>(L, 1);
            System.Type arg1 = LuaCallback.ToType(L, 2);
            System.Collections.Generic.List<UnityEngine.Component> arg2 = LuaCallback.ToObject<System.Collections.Generic.List<UnityEngine.Component>>(L, 3);
    ...
    public static int FindWithTag(System.IntPtr L)
    {
        ...
        if (nargs == 1 && LuaAPI.IsString(L, 1))
        {
            ...
            System.String arg0 = LuaCallback.ToString(L, 1);
    ...
    public static int SendMessageUpwards(System.IntPtr L)
    {
        ...
        if (nargs == 3 && LuaAPI.IsObject(L, 1) && LuaAPI.IsString(L, 2) && LuaAPI.IsNumber(L, 3))
        {
            UnityEngine.GameObject arg0 = LuaCallback.ToObject<UnityEngine.GameObject>(L, 1);
            System.String arg1 = LuaCallback.ToString(L, 2);
            UnityEngine.SendMessageOptions arg2 = (UnityEngine.SendMessageOptions)LuaAPI.ToNumber(L, 3);
        ...
        if (nargs == 4 && LuaAPI.IsObject(L, 1) && LuaAPI.IsString(L, 2) && LuaAPI.IsObject(L, 3) && LuaAPI.IsNumber(L, 4))
        {
            UnityEngine.GameObject arg0 = LuaCallback.ToObject<UnityEngine.GameObject>(L, 1);
            System.String arg1 = LuaCallback.ToString(L, 2);
            System.Object arg2 = LuaCallback.ToObject<System.Object>(L, 3);
            UnityEngine.SendMessageOptions arg3 = (UnityEngine.SendMessageOptions)LuaAPI.ToNumber(L, 4);
